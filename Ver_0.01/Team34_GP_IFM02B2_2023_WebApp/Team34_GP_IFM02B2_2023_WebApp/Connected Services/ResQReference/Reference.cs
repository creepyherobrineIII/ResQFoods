...
namespace Team34_GP_IFM02B2_2023_WebApp.ResQReference {
    ...
    public interface IRESQSERVICE {
        ...
        bool AddProduct(int sID, string name, string desc, int quant, double price, string picPath, System.DateTime date, int tg, bool enabled);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IRESQSERVICE/AddProduct", ReplyAction="http://tempuri.org/IRESQSERVICE/AddProductResponse")]
        System.Threading.Tasks.Task<bool> AddProductAsync(int sID, string name, string desc, int quant, double price, string picPath, System.DateTime date, int tg, bool enabled);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IRESQSERVICE/AddProdTag", ReplyAction="http://tempuri.org/IRESQSERVICE/AddProdTagResponse")]
        bool AddProdTag(int pID, int tID);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IRESQSERVICE/AddProdTag", ReplyAction="http://tempuri.org/IRESQSERVICE/AddProdTagResponse")]
        System.Threading.Tasks.Task<bool> AddProdTagAsync(int pID, int tID);
        ...
        bool editProduct(Team34_GP_IFM02B2_2023_WebApp.ResQReference.Product P, int tg);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IRESQSERVICE/editProduct", ReplyAction="http://tempuri.org/IRESQSERVICE/editProductResponse")]
        System.Threading.Tasks.Task<bool> editProductAsync(Team34_GP_IFM02B2_2023_WebApp.ResQReference.Product P, int tg);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IRESQSERVICE/decProduct", ReplyAction="http://tempuri.org/IRESQSERVICE/decProductResponse")]
        bool decProduct(int prodID);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IRESQSERVICE/decProduct", ReplyAction="http://tempuri.org/IRESQSERVICE/decProductResponse")]
        System.Threading.Tasks.Task<bool> decProductAsync(int prodID);
        ...
        bool addInvoice(int UID, decimal price, System.DateTime TOS, int[] prodIds, int[] Quantities);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IRESQSERVICE/addInvoice", ReplyAction="http://tempuri.org/IRESQSERVICE/addInvoiceResponse")]
        System.Threading.Tasks.Task<bool> addInvoiceAsync(int UID, decimal price, System.DateTime TOS, int[] prodIds, int[] Quantities);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IRESQSERVICE/addInvoiceItem", ReplyAction="http://tempuri.org/IRESQSERVICE/addInvoiceItemResponse")]
        System.Threading.Tasks.Task<bool> addInvoiceItemAsync(int ID, int ProdID, int Quantity);
        ...
        Team34_GP_IFM02B2_2023_WebApp.ResQReference.Product[] getFilteredList(string name, double P1, double P2, int filTag, int manu);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IRESQSERVICE/getFilteredList", ReplyAction="http://tempuri.org/IRESQSERVICE/getFilteredListResponse")]
        System.Threading.Tasks.Task<Team34_GP_IFM02B2_2023_WebApp.ResQReference.Product[]> getFilteredListAsync(string name, double P1, double P2, int filTag, int manu);
    ...
    public partial class RESQSERVICEClient : System.ServiceModel.ClientBase<Team34_GP_IFM02B2_2023_WebApp.ResQReference.IRESQSERVICE>, Team34_GP_IFM02B2_2023_WebApp.ResQReference.IRESQSERVICE {
        ...
        public bool AddProduct(int sID, string name, string desc, int quant, double price, string picPath, System.DateTime date, int tg, bool enabled) {
            return base.Channel.AddProduct(sID, name, desc, quant, price, picPath, date, tg, enabled);
        }
        
        public System.Threading.Tasks.Task<bool> AddProductAsync(int sID, string name, string desc, int quant, double price, string picPath, System.DateTime date, int tg, bool enabled) {
            return base.Channel.AddProductAsync(sID, name, desc, quant, price, picPath, date, tg, enabled);
        }
        
        public bool AddProdTag(int pID, int tID) {
            return base.Channel.AddProdTag(pID, tID);
        }
        
        public System.Threading.Tasks.Task<bool> AddProdTagAsync(int pID, int tID) {
            return base.Channel.AddProdTagAsync(pID, tID);
        }
        ...
        public bool editProduct(Team34_GP_IFM02B2_2023_WebApp.ResQReference.Product P, int tg) {
            return base.Channel.editProduct(P, tg);
        }
        
        public System.Threading.Tasks.Task<bool> editProductAsync(Team34_GP_IFM02B2_2023_WebApp.ResQReference.Product P, int tg) {
            return base.Channel.editProductAsync(P, tg);
        }
        
        public bool decProduct(int prodID) {
            return base.Channel.decProduct(prodID);
        }
        
        public System.Threading.Tasks.Task<bool> decProductAsync(int prodID) {
            return base.Channel.decProductAsync(prodID);
        }
        ...
        public bool addInvoice(int UID, decimal price, System.DateTime TOS, int[] prodIds, int[] Quantities) {
            return base.Channel.addInvoice(UID, price, TOS, prodIds, Quantities);
        }
        
        public System.Threading.Tasks.Task<bool> addInvoiceAsync(int UID, decimal price, System.DateTime TOS, int[] prodIds, int[] Quantities) {
            return base.Channel.addInvoiceAsync(UID, price, TOS, prodIds, Quantities);
        }
        
        public bool addInvoiceItem(int ID, int ProdID, int Quantity) {
            return base.Channel.addInvoiceItem(ID, ProdID, Quantity);
        }
        
        public System.Threading.Tasks.Task<bool> addInvoiceItemAsync(int ID, int ProdID, int Quantity) {
            return base.Channel.addInvoiceItemAsync(ID, ProdID, Quantity);
        }
        
        public Team34_GP_IFM02B2_2023_WebApp.ResQReference.Product[] getFilteredList(string name, double P1, double P2, int filTag, int manu) {
            return base.Channel.getFilteredList(name, P1, P2, filTag, manu);
        }
        
        public System.Threading.Tasks.Task<Team34_GP_IFM02B2_2023_WebApp.ResQReference.Product[]> getFilteredListAsync(string name, double P1, double P2, int filTag, int manu) {
            return base.Channel.getFilteredListAsync(name, P1, P2, filTag, manu);
        }
